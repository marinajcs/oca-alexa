...
\begin{itemize}
    \item \textbf{RNF1.1}: La skill debe ser fácil de usar y entender, diseñada para personas mayores.
...
\begin{itemize}
    \item \textbf{RNF3.1}: Los tiempos de respuesta deben ser rápidos, idealmente menos de 5 segundos.
\end{itemize}
