...
\subsubsection{AWS Serverless Platform}
...
\subsubsection{Alexa Presentation Language (APL)}
...
\subsection{Estructura de una skill de Alexa}

+ frontend (VUI)

+ backend (lógica proc. órdenes)
